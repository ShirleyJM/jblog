...
public class BlogController {
	...
	@RequestMapping(value = "/{id}/blogAdminBasicModify", method = RequestMethod.POST)
	public String BlogAdminBasicModify(@PathVariable("id") String id,@RequestParam("file") MultipartFile file,
			@RequestParam("blogTitle") String blogTitle,Model model) {
			System.out.println("된다");
			blogService.blogAdminBasicModify(id,file,blogTitle);
